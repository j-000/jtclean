...
from wtforms import StringField, PasswordField, BooleanField, TextAreaField, DecimalField, SelectField, DateTimeField, TimeField, IntegerField
...
class BookingForm(FlaskForm):
    ...
    date = DateTimeField('Data', validators=[InputRequired()], id='datepicker')
    ...
    duration = IntegerField('Quantas horas necessita?', validators=[InputRequired()])
